...
/// FakeWatermarkTests's anchored-on-DialogEditor.slnx XML-scan pattern — a future
/// accidental removal fails this too.
/// </summary>
public class FocusHintBarPresenceTests
{
    ...
    private static bool IsExcluded(string root, string path)
    {
        ...
        return segments.Any(s => s is "bin" or "obj" or ".worktrees");
    }
